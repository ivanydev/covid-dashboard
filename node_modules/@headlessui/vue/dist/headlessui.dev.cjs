...
var globalId = 0;
function useId() {
  let generateId = (0, import_vue3.inject)(GENERATE_ID, () => {
    return `${++globalId}`;
  });
  return generateId();
}
function provideUseId(fn) {
  (0, import_vue3.provide)(GENERATE_ID, fn);
}
...
var ComboboxLabel = (0, import_vue14.defineComponent)({
  ...
  setup(props, { attrs, slots }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-combobox-label-${useId()}`;
    let api = useComboboxContext("ComboboxLabel");
    function handleClick() {
      var _a2;
      (_a2 = dom(api.inputRef)) == null ? void 0 : _a2.focus({ preventScroll: true });
    }
    return () => {
      let slot = {
        open: api.comboboxState.value === 0 /* Open */,
...
var ComboboxButton = (0, import_vue14.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-combobox-button-${useId()}`;
    ...
    function handleKeydown(event) {
      switch (event.key) {
        case "ArrowDown" /* ArrowDown */:
          ...
          (0, import_vue14.nextTick)(() => {
            var _a2;
            return (_a2 = api.inputRef.value) == null ? void 0 : _a2.focus({ preventScroll: true });
          });
          return;
    ...
    return () => {
      ...
      let ourProps = {
        ...
        "aria-controls": (_a2 = dom(api.optionsRef)) == null ? void 0 : _a2.id,
...
var ComboboxInput = (0, import_vue14.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-combobox-input-${useId()}`;
    ...
    let currentDisplayValue = (0, import_vue14.computed)(() => {
      ...
      if (typeof props.displayValue !== "undefined" && value !== void 0) {
        return (_a2 = props.displayValue(value)) != null ? _a2 : "";
      } else if (typeof value === "string") {
        return value;
      } else {
        return "";
      ...
      (0, import_vue14.watch)(
        ...
        ([currentDisplayValue2, state], [oldCurrentDisplayValue, oldState]) => {
          ...
          requestAnimationFrame(() => {
            ...
            if (!input)
              return;
            if (((_a2 = ownerDocument.value) == null ? void 0 : _a2.activeElement) !== input)
              return;
    ...
    function handleBlur(event) {
      var _a2, _b, _c;
      let relatedTarget = (_a2 = event.relatedTarget) != null ? _a2 : history.find((x) => x !== event.currentTarget);
      isTyping.value = false;
    ...
    let defaultValue = (0, import_vue14.computed)(() => {
      var _a2, _b, _c, _d;
      return (_d = (_c = (_b = props.defaultValue) != null ? _b : api.defaultValue.value !== void 0 ? (_a2 = props.displayValue) == null ? void 0 : _a2.call(props, api.defaultValue.value) : null) != null ? _c : api.defaultValue.value) != null ? _d : "";
    });
    return () => {
      ...
      let ourProps = {
        "aria-controls": (_a2 = api.optionsRef.value) == null ? void 0 : _a2.id,
        "aria-expanded": api.comboboxState.value === 0 /* Open */,
...
var ComboboxOption = (0, import_vue14.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let active = (0, import_vue14.computed)(() => {
      var _a;
      return api.virtual.value ? api.activeOptionIndex.value === api.calculateIndex(props.value) : api.activeOptionIndex.value === null ? false : ((_a = api.options.value[api.activeOptionIndex.value]) == null ? void 0 : _a.id) === id;
    });
...
var Dialog = (0, import_vue26.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    var _a, _b;
    let id = (_a = props.id) != null ? _a : `headlessui-dialog-${useId()}`;
    ...
    let resolveRootOfMainTreeNode = (0, import_vue26.computed)(() => {
      var _a2, _b2, _c;
      return (_c = Array.from((_b2 = (_a2 = ownerDocument.value) == null ? void 0 : _a2.querySelectorAll("body > *")) != null ? _b2 : []).find((root) => {
    ...
    let resolveRootOfParentDialog = (0, import_vue26.computed)(() => {
      ...
      return (_c = Array.from(
        (_b2 = (_a2 = ownerDocument.value) == null ? void 0 : _a2.querySelectorAll("[data-headlessui-portal]")) != null ? _b2 : []
...
var DialogOverlay = (0, import_vue26.defineComponent)({
  ...
  setup(props, { attrs, slots }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-dialog-overlay-${useId()}`;
...
var DialogBackdrop = (0, import_vue26.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-dialog-backdrop-${useId()}`;
...
var DialogPanel = (0, import_vue26.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-dialog-panel-${useId()}`;
...
var DialogTitle = (0, import_vue26.defineComponent)({
  ...
  setup(props, { attrs, slots }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-dialog-title-${useId()}`;
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      let ourProps = isWithinPanel.value ? {
        ...
        id: (_a = api.buttonId.value) != null ? _a : id,
        ref: internalButtonRef,
        type: type.value,
...
var DisclosurePanel = (0, import_vue27.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      let { id, ...theirProps } = props;
      let ourProps = { id: (_a = api.panelId.value) != null ? _a : id, ref: api.panel };
      return render({
        ourProps,
        theirProps,
        slot,
...
var ListboxLabel = (0, import_vue29.defineComponent)({
  ...
  setup(props, { attrs, slots }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-listbox-label-${useId()}`;
    let api = useListboxContext("ListboxLabel");
    function handleClick() {
      var _a2;
      (_a2 = dom(api.buttonRef)) == null ? void 0 : _a2.focus({ preventScroll: true });
    }
    return () => {
      let slot = {
...
var ListboxButton = (0, import_vue29.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-listbox-button-${useId()}`;
      ...
      switch (event.key) {
        ...
        case "ArrowDown" /* ArrowDown */:
          ...
          (0, import_vue29.nextTick)(() => {
            var _a2;
            (_a2 = dom(api.optionsRef)) == null ? void 0 : _a2.focus({ preventScroll: true });
            if (!api.value.value)
    ...
    function handleClick(event) {
      ...
      if (api.listboxState.value === 0 /* Open */) {
        ...
        nextFrame(() => {
          var _a2;
          return (_a2 = dom(api.optionsRef)) == null ? void 0 : _a2.focus({ preventScroll: true });
        });
      }
    }
    let type = useResolveButtonType(
...
var ListboxOptions = (0, import_vue29.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-listbox-options-${useId()}`;
    ...
    return () => {
      ...
      let { ...theirProps } = props;
      let ourProps = {
        "aria-activedescendant": api.activeOptionIndex.value === null ? void 0 : (_a2 = api.options.value[api.activeOptionIndex.value]) == null ? void 0 : _a2.id,
        "aria-multiselectable": api.mode.value === 1 /* Multi */ ? true : void 0,
...
var ListboxOption = (0, import_vue29.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-listbox-option-${useId()}`;
...
var MenuButton = (0, import_vue30.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-menu-button-${useId()}`;
      ...
      switch (event.key) {
        ...
        case "ArrowDown" /* ArrowDown */:
          ...
          (0, import_vue30.nextTick)(() => {
            var _a2;
            (_a2 = dom(api.itemsRef)) == null ? void 0 : _a2.focus({ preventScroll: true });
    ...
    function handleClick(event) {
      ...
      if (api.menuState.value === 0 /* Open */) {
        ...
        nextFrame2(() => {
          var _a2;
          return (_a2 = dom(api.itemsRef)) == null ? void 0 : _a2.focus({ preventScroll: true });
        });
      }
    }
    let type = useResolveButtonType(
    ...
    return () => {
      ...
      let ourProps = {
        ...
        type: type.value,
        "aria-haspopup": "menu",
        "aria-controls": (_a2 = dom(api.itemsRef)) == null ? void 0 : _a2.id,
...
var MenuItems = (0, import_vue30.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-menu-items-${useId()}`;
      ...
      switch (event.key) {
        ...
        case "Enter" /* Enter */:
          ...
          if (api.activeItemIndex.value !== null) {
            ...
            (_a2 = dom(_activeItem.dataRef.domRef)) == null ? void 0 : _a2.click();
          }
          api.closeMenu();
    ...
    return () => {
      ...
      let { ...theirProps } = props;
      let ourProps = {
        "aria-activedescendant": api.activeItemIndex.value === null ? void 0 : (_a2 = api.items.value[api.activeItemIndex.value]) == null ? void 0 : _a2.id,
        "aria-labelledby": (_b = dom(api.buttonRef)) == null ? void 0 : _b.id,
        id,
        onKeydown: handleKeyDown,
        onKeyup: handleKeyUp,
...
var MenuItem = (0, import_vue30.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-menu-item-${useId()}`;
    ...
    (0, import_vue30.watchEffect)(() => {
      ...
      (0, import_vue30.nextTick)(() => {
        var _a2, _b;
        return (_b = (_a2 = dom(internalItemRef)) == null ? void 0 : _a2.scrollIntoView) == null ? void 0 : _b.call(_a2, { block: "nearest" });
      });
    });
    function handleClick(event) {
      if (props.disabled)
...
var RadioGroup = (0, import_vue33.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-radiogroup-${useId()}`;
        ...
        case "ArrowUp" /* ArrowUp */:
          {
            ...
            if (result === 2 /* Success */) {
              let activeOption = options.value.find(
                (option) => {
                  var _a2;
                  return option.element === ((_a2 = getOwnerDocument(radioGroupRef)) == null ? void 0 : _a2.activeElement);
                }
              );
              if (activeOption)
        ...
        case "ArrowDown" /* ArrowDown */:
          {
            ...
            if (result === 2 /* Success */) {
              let activeOption = options.value.find(
                (option) => {
                  var _a2;
                  return option.element === ((_a2 = getOwnerDocument(option.element)) == null ? void 0 : _a2.activeElement);
                }
              );
              if (activeOption)
                api.change(activeOption.propsRef.value);
    ...
    let form = (0, import_vue33.computed)(() => {
      var _a2;
      return (_a2 = dom(radioGroupRef)) == null ? void 0 : _a2.closest("form");
    });
...
var RadioGroupOption = (0, import_vue33.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-radiogroup-option-${useId()}`;
    ...
    let isFirstOption = (0, import_vue33.computed)(() => {
      var _a2;
      return ((_a2 = api.firstOption.value) == null ? void 0 : _a2.id) === id;
    });
    ...
    function handleClick() {
      ...
      (_a2 = dom(optionRef)) == null ? void 0 : _a2.focus();
    }
    function handleFocus() {
      state.value |= 2 /* Active */;
    }
...
var Tab = (0, import_vue36.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-tabs-tab-${useId()}`;
    ...
    function activateUsing(cb) {
      ...
      if (result === 2 /* Success */ && api.activation.value === "auto") {
        let newTab = (_a2 = getOwnerDocument(internalTabRef)) == null ? void 0 : _a2.activeElement;
    ...
    function handleSelection() {
      ...
      if (props.disabled)
        return;
      (_a2 = dom(internalTabRef)) == null ? void 0 : _a2.focus({ preventScroll: true });
      api.setSelectedIndex(myIndex.value);
      microTask(() => {
        ready.value = false;
      });
    ...
    return () => {
      ...
      let ourProps = {
        ...
        role: "tab",
        type: type.value,
        "aria-controls": (_a2 = dom(api.panels.value[myIndex.value])) == null ? void 0 : _a2.id,
        "aria-selected": selected.value,
...
var TabPanel = (0, import_vue36.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    var _a;
    let id = (_a = props.id) != null ? _a : `headlessui-tabs-panel-${useId()}`;
    ...
    return () => {
      ...
      let ourProps = {
        ...
        id,
        role: "tabpanel",
        "aria-labelledby": (_a2 = dom(api.tabs.value[myIndex.value])) == null ? void 0 : _a2.id,
